...
>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            <div class="max-w-2xl">
                <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-stone-warm-200/80 border border-stone-warm-300 text-[11px] font-semibold uppercase tracking-wider text-stone-warm-800 mb-3">
                ...
                <p class="mt-3 text-sm sm:text-base text-stone-warm-700 leading-relaxed">
        ...
        >
            @foreach($reviews as $review)
                <div class="flex-none w-[300px] sm:w-[380px] lg:w-[410px] snap-start">
