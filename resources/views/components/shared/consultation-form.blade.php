<form data-consultation-form novalidate class="space-y-5 border border-stone-warm-300 bg-stone-warm-50 p-6" aria-describedby="consultation-form-note">
    <p id="consultation-form-note" class="text-sm leading-relaxed text-stone-warm-700">POC only: this form validates in your browser and does not send information, create an appointment, or persist data.</p>
    ...
    <button type="submit" class="inline-flex min-h-[44px] items-center justify-center bg-charcoal-900 px-5 py-2 text-sm font-semibold text-stone-warm-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-charcoal-900 focus-visible:ring-offset-2">Preview consultation request</button>
