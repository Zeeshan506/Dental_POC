...
- [ ] Task 4.5: Preference-resolution/rendering tests, production build, Pint, line-count, and whitespace checks pass. Browser comparison of every palette/typeface in both variants remains pending manual review; do not mark this task done yet.
