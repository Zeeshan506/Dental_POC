...
| Phase 5 | Variant B Calm Editorial Site-Wide Motion | [Phase 5 Spec](2026-09-21-phase-5-variant-b-editorial-motion/) | AC-1 to AC-12 | Ready | Not Started | Pending |
...
- [ ] **Task 5.2**: Apply the central motion system to every Variant B and shared page block using a distinct calm editorial profile, then recompose Variant B into an original reference-informed full-bleed editorial hierarchy.
